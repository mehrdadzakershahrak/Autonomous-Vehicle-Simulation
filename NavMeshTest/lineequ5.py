...
def is_covered_x2(((x1, y1), (x2, y2)), ((x3, y3), (x4, y4))):
    if min(x1, x2) <= min(x3, x4) and min(x3, x4) <= max(x1, x2):
        return True
    elif min(x3, x4) <= min(x1, x2) and min(x1, x2) <= max(x3, x4):
        return True
...
def is_covered_y2(((x1, y1), (x2, y2)), ((x3, y3), (x4, y4))):
    if min(y1, y2) <= min(y3, y4) and min(y3, y4) <= may(y1, y2):
        return True
    elif min(y3, y4) <= min(y1, y2) and min(y1, y2) <= may(y3, y4):
        return True
    elif may(y1, y2) < min(y3, y4):
        return False
    elif may(y3, y4) < min(y1, y2):
        return False
    else:
        return False
...
def hh(points1, points2):
    ...
    if y1 == y3:
        ...
        return is_covered_x2(points1, points2)
    return False
...
def vv(points1, points2):
    ...
    if x1 == x3:
        ...
        return is_covered_y2(points1, points2)
    return False
